    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-slate-500">
          Acompanhe suas estatísticas pela A.D. Cannabrava.
        </p>
      </div>
      ...
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Card
          titulo="Partidas"
          valor="0"
          descricao="Total de participações"
        />
      ...
      <section className="mt-7 rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Jogos oficiais, amistosos e jogos-treino são contabilizados separadamente.
          </p>
        </div>
      ...
      <section className="mt-7 rounded-2xl border border-slate-200 bg-white">
        ...
        <div className="border-b border-slate-200 p-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Histórico recente de participação.
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="rounded-xl border border-dashed border-slate-300 p-10 text-center">
            ...
            <p className="mt-1 text-sm text-slate-400">
              Suas participações aparecerão aqui após o registro das partidas.
            </p>
